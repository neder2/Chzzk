/**
 * MAIN-world entry for volumeControls.js. Chromium de-duplicates script paths across worlds.
 * Keep the implementation identical to volumeControls.js; the packaging regression test checks it.
 */
(() => {
