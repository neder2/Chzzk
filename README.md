...
**Better Chzzk**는 자동 화질 복구, 단축키 복구, 다시보기 스킵/검색, 방송 목록 필터, 채널 방송 시간 통계, 라이브 시청 기록, 안내 팝업 정리 등의 기능을 한곳에 모은 확장 프로그램입니다. 대부분의 기능은 설정 화면에서 개별로 켜고 끌 수 있으며, 세부 수치까지 직접 조절할 수 있습니다.
