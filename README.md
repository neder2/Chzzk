...
**원인:** AdGuard 같은 광고 차단 프로그램의 **한국어 필터(List-KR)** 룰과 확장 프로그램이 같은 페이지 전역을 건드리며 충돌할 때 발생하는 현상으로 진단되었습니다. **1.1.6부터 충돌 의심 코드를 비활성화**해 두었지만, 증상이 간헐적이라 그래도 나타나는 경우 아래 방법으로 해결할 수 있습니다.
