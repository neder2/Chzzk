...
- 방송자·채팅 운영자 모아보기에 **사용자별 필터와 미확인 채팅 알림**을 추가했습니다. 패널에서 실제로 확인한 채팅의 알림만 해제됩니다.
- 모아보기에서 **여러 채팅 선택·복사**와 **맨 아래로 이동**을 지원하고, 선택 중 자동 스크롤과 원본 채팅 위치 이동을 보강했습니다.
- 접힌 팔로잉 목록에 보충된 고정 채널을 클릭하면 **페이지 내부에서 이동**하도록 수정했습니다.
