...
버전 업데이트, GitHub 메인 머지, 릴리스 작업을 할 때는 GitHub Release 또는 업데이트 내역을 반드시 작성하거나 갱신한다.

커밋할 때 커밋 제목의 첫 줄은 변경 내용 요약 대신 해당 변경이 속하는 릴리스 버전만 표시하는 `Better Chzzk <version>` 형식으로 통일한다. 예: `Better Chzzk 1.2.0`
